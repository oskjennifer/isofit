...
isofit apply_oe small_chunk/${file_base}_rdn_7000-7010 small_chunk/${file_base}_loc_7000-7010 small_chunk/${file_base}_obs_7000-7010 small_chunk/L2A_reflectance ang --n_cores 4 --presolve --emulator_base ${EMULATOR_PATH} --segmentation_size 400 --pressure_elevation -sp ../20171108_Pasadena/configs/ang20171108t184227_surface.json
